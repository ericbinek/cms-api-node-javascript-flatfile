...
import { findById as findAccountById } from '../models/account.mjs';
...
const ANONYMOUS = { role: 'anonymous', accountId: null, username: null };
...
export function requiresSession(method, principal) {
