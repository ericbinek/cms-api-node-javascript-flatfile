...
const REQUIRED_FIELDS = new Set(["name","termCode","inDefinedTermSet"]);
const SEARCHABLE_FIELDS = new Set(["name","description","termCode"]);
const SORTABLE_FIELDS = new Set(["dateCreated", "dateModified", ...["name","description","termCode","url"]]);

const SYSTEM_FIELDS = new Set(['id', 'dateCreated', 'dateModified', '@context', '@type']);

const REF_COLLECTIONS = {"DefinedTermSet":"defined-term-sets.json"};
