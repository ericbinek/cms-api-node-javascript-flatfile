...
const REQUIRED_FIELDS = new Set(["headline"]);
const SEARCHABLE_FIELDS = new Set(["headline","description","text"]);
const SORTABLE_FIELDS = new Set(["dateCreated", "dateModified", ...["headline","description","text","datePublished","dateModified","dateCreated","url","creativeWorkStatus"]]);
