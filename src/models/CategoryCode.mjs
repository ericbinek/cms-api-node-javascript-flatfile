...
const REQUIRED_FIELDS = new Set(["name","codeValue","inCodeSet"]);
const SEARCHABLE_FIELDS = new Set(["name","description","codeValue"]);
const SORTABLE_FIELDS = new Set(["dateCreated", "dateModified", ...["name","description","codeValue","url"]]);

const SYSTEM_FIELDS = new Set(['id', 'dateCreated', 'dateModified', '@context', '@type']);

const REF_COLLECTIONS = {"CategoryCodeSet":"category-code-sets.json"};
