...
const SEARCHABLE_FIELDS = new Set(["name","caption","description","encodingFormat"]);
const SORTABLE_FIELDS = new Set(["dateCreated", "dateModified", ...["name","caption","description","contentUrl","encodingFormat","uploadDate","license"]]);

const SYSTEM_FIELDS = new Set(['id', 'dateCreated', 'dateModified', '@context', '@type']);

const REF_COLLECTIONS = {"Person":"persons.json"};
