...
const REQUIRED_FIELDS = new Set(["text","author","about"]);
const SEARCHABLE_FIELDS = new Set(["text"]);
const SORTABLE_FIELDS = new Set(["dateCreated", "dateModified", ...["text","dateCreated","dateModified","upvoteCount","downvoteCount","creativeWorkStatus"]]);

const SYSTEM_FIELDS = new Set(['id', 'dateCreated', 'dateModified', '@context', '@type']);

const REF_COLLECTIONS = {"Person":"persons.json","BlogPosting":"blog-postings.json","Comment":"comments.json"};
