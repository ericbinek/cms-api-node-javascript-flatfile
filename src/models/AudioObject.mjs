...
const SEARCHABLE_FIELDS = new Set(["name","description","encodingFormat","transcript"]);
const SORTABLE_FIELDS = new Set(["dateCreated", "dateModified", ...["name","description","contentUrl","encodingFormat","duration","transcript","uploadDate"]]);
