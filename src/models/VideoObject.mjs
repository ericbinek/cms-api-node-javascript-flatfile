...
const REQUIRED_FIELDS = new Set(["contentUrl"]);
const SEARCHABLE_FIELDS = new Set(["name","description","encodingFormat","videoQuality","transcript","caption"]);
const SORTABLE_FIELDS = new Set(["dateCreated", "dateModified", ...["name","description","contentUrl","embedUrl","encodingFormat","duration","videoQuality","transcript","caption","uploadDate"]]);
